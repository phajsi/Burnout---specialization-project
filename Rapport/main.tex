...
\documentclass[pdftex, 11pt, english, a4paper, twoside]{report} %%{article} 
...
\input{Rapport/1-Abstract++/001-title}
%\input{Rapport/1-Abstract++/002 - Acknowledgement}
%\input{Rapport/1-Abstract++/003 - Abstract}
%\input{Rapport/1-Abstract++/004 - Lists}
\tableofcontents

\input{Rapport/Chapters/Introduction}
\input{Rapport/Chapters/Problem Definition}
\input{Rapport/Chapters/Literature Review}
\input{Rapport/Chapters/Co-Design Workshop}
\input{Rapport/Chapters/Interviews}
...
%\bibliography{bibliography.bib} %navnet i krøllparantesene er navnet på .bib filen til bibliografien
